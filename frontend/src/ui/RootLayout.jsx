      ...
      <header className="sticky top-0 z-40 bg-white/95 dark:bg-gray-900/90 backdrop-blur-md border-b border-golden-300 dark:border-golden-700 shadow-glossy">
        <div className="container-responsive flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            <NavLink to="/" end className={({isActive})=>`hover:text-brand-primary transition-all duration-300 hover:scale-105 ${isActive? 'text-brand-primary font-semibold' : 'text-gray-700 dark:text-gray-300'}`}>Home</NavLink>
            <NavLink to="/shop" className={({isActive})=>`hover:text-brand-primary transition-all duration-300 hover:scale-105 ${isActive? 'text-brand-primary font-semibold' : 'text-gray-700 dark:text-gray-300'}`}>Shop</NavLink>
            <NavLink to="/about" className={({isActive})=>`hover:text-brand-primary transition-all duration-300 hover:scale-105 ${isActive? 'text-brand-primary font-semibold' : 'text-gray-700 dark:text-gray-300'}`}>About Us</NavLink>
        ...
        {isMobileMenu && (
          <div className="md:hidden border-t bg-white/95 dark:bg-gray-900/95 backdrop-blur border-golden-200">
            <div className="container-responsive py-6 grid gap-4 text-lg">
              <NavLink to="/" onClick={()=>setIsMobileMenu(false)} className="hover:text-brand-primary transition-colors font-medium">Home</NavLink>
              <details><summary className="cursor-pointer hover:text-brand-primary transition-colors font-medium">Womenswear</summary><div className="mt-2 grid grid-cols-2 gap-3 text-sm text-gray-600 dark:text-gray-300"><a href="#" className="hover:text-brand-primary transition-colors">Sarees</a><a href="#" className="hover:text-brand-primary transition-colors">Lehengas</a><a href="#" className="hover:text-brand-primary transition-colors">Kurta Sets</a></div></details>
              <details><summary className="cursor-pointer hover:text-brand-primary transition-colors font-medium">Kidswear</summary><div className="mt-2 grid grid-cols-2 gap-3 text-sm text-gray-600 dark:text-gray-300"><a href="#" className="hover:text-brand-primary transition-colors">Girls</a><a href="#" className="hover:text-brand-primary transition-colors">Boys</a></div></details>
              <NavLink to="/shop" onClick={()=>setIsMobileMenu(false)} className="hover:text-brand-primary transition-colors font-medium">Shop</NavLink>
              <NavLink to="/about" onClick={()=>setIsMobileMenu(false)} className="hover:text-brand-primary transition-colors font-medium">About Us</NavLink>
              <NavLink to="/contact" onClick={()=>setIsMobileMenu(false)} className="hover:text-brand-primary transition-colors font-medium">Contact Us</NavLink>
              <NavLink to="/account" onClick={()=>setIsMobileMenu(false)} className="hover:text-brand-primary transition-colors font-medium">My Account</NavLink>
              <NavLink to="/cart" onClick={()=>setIsMobileMenu(false)} className="hover:text-brand-primary transition-colors font-medium">Cart</NavLink>
            </div>
          </div>
        )}
      </header>
